...
void MX_SPI1_Init(void)
{
  ...
  PA7   ------> SPI1_MOSI
  */
  GPIO_InitStruct.Pin = SPI1_NSS_Flash_Pin|SPI1_SCK_Flash_Pin|SPI1_MISO_Flash_Pin|SPI1_MOSI_Flash_Pin;
...
void MX_SPI2_Init(void)
{
  ...
  PB9   ------> SPI2_NSS
  */
  GPIO_InitStruct.Pin = LL_GPIO_PIN_10|LL_GPIO_PIN_15|LL_GPIO_PIN_9;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
void MX_SPI5_Init(void)
{
  ...
  */
  ...
  /* SPI5 interrupt Init */
  NVIC_SetPriority(SPI5_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),2, 0));
